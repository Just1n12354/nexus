...
§
Wo was liegt in nexus grob: persönliche Fakten unter 02_personen/privat/, Systeme unter 06_systeme/, Arbeit unter 08_arbeit/, Robotik unter 09_roboter/, Logs unter 00_Log/; Projekt-/Konzeptnotizen aktuell unter 03_projekte/. Für konkrete Pfade immer live nachsehen statt alte Strukturannahmen zu vertrauen.
§
...
§
Bearer-authentifizierte interne Apps laufen auf einem Tailscale-Host; bei Bedarf direkt abrufen (Key-Speicherorte siehe 07_referenz/secrets-locations.md).
§
Lunas visuelle Identität: elegant, ruhig, futuristisch, leicht mysteriös/high-tech; Dark-Mode mit blau/violetten Neon-Akzenten. Standard-Avatar: nexus 04_agenten/Luna/LunaPB.png (junge Frau, lange dunkelbraune Wellen, ruhiger direkter Blick, dunkles elegant-futuristisches Outfit mit Leuchtakzenten).
§
